...
1. Heng, Zhou, and Chi. [Bayesian Trend Filtering via Proximal Markov Chain Monte Carlo](https://doi.org/10.1080/10618600.2023.2170089)  
...
4. Bergmeir, Hyndman, Koo. [A note on the validity of cross-validation for evaluating autoregressive time series prediction](https://robjhyndman.com/papers/cv-wp.pdf)  
